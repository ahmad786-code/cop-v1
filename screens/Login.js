                    ...
                    <ScrollView   showsVerticalScrollIndicator={false} bounces={false} >
                        ...
                        <View style={styles.inputContainer}>
                            ...
                            <TouchableOpacity onPress={() => focusTextInput(userRef)} activeOpacity={1} style={styles.input}>
                                ...
                                <TextInput id='userName' onChangeText={(value) => inputChangedHandler('email', value)}  ref={userRef} style={{ color: Color.colorWhite }} placeholder='Enter Username' placeholderTextColor={Color.colorGray_100} />
